...
export default function DashboardPage() {
  ...
  const handleMedicalRecordUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // reader.onloadend = () => {
    //   const base64String = reader.result as string
    //   setMedicalRecordData({...medicalRecordData, document: base64String})
    // }
                    ...
                    <Image
                      src={
                        activeSection === "profile"
                          ? (profileImageBase64 === "null" ? "/placeholder.svg?height=120&width=120" : parentProfile.profileImage || "/placeholder.svg?height=120&width=120")
                          : activeChild
                            ? activeChild.image
